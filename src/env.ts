...
- 如果本项目对你有所帮助，可以给[站长](https://www.wordsworth.site/)一点[赞助](https://cdn.jsdelivr.net/gh/Logic-H/imglibrary@main/img/01A1ABCEEFA25C153C68E45504DF7F8A.jpg)。
- 本站仅作小范围使用，用爱发电，维护不易，请勿外流
- 点击每条消息前的头像，可以锁定对话，作为角色设定。
- 现在支持多个对话，打开对话设置，点击新建对话。在输入框里输入 [[/]][[/]] 或者     
 [[空格]][[空格]] 可以切换对话，搜索历史消息。
